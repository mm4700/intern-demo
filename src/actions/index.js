...
export function fetchData(dataset, opts) {
  return (dispatch, state) => {
    ...
    return new Promise((resolve, reject) => {
      agent.post('http://http://ec2-54-187-232-182.us-west-2.compute.amazonaws.com:5001/api/v1/data/' + dataset)
        .send(data)
...
export function fetchEvents(opts) {
  return (dispatch, state) => {
    ...
    return new Promise((resolve, reject) => {
      agent.post('http://http://ec2-54-187-232-182.us-west-2.compute.amazonaws.com:5001/api/v1/events')
        .send(data)
        .set('Accept', 'application/json')
        .end((err, response) => {
          if (err) {
...
export function fetchMeasurements(opts) {
  return (dispatch, state) => {
    ...
    return new Promise((resolve, reject) => {
      agent.post('http://http://ec2-54-187-232-182.us-west-2.compute.amazonaws.com:5001/api/v1/measurements')
        .send(data)
        .set('Accept', 'application/json')
        .end((err, response) => {
          if (err) {
